...
function main() {
    ...
    btnClicked.addEventListener("click", function(event) {
        ...
        console.log("className: " + event.target.className + " Id " + event.target.id);
...
function compare() {
    ...
    if (compareSequence(machineSequence)) {
        ...
        document.querySelector("#youLost").innerHTML = "You pressed the wrong button. Try again!";
...
function flashElement(element, buttonName) {
    ...
    setTimeout(function() {
        element.classList.remove(buttonName);}, 3000);        
}
    ...
    strictBtn.addEventListener("click", function(event) {
        ...
        if (event.target.className === "child") {
            ...
            humanPlay(event.target.id); /* flush and play music */
                ...
                console.log("You pressed the wrong button. Game will restart. " + machineSequence);
                              next(machineSequence);
...
function machinePlay(sequence) {
    let audio = ["https://s3.amazonaws.com/freecodecamp/simonSound1.mp3",                "https://s3.amazonaws.com/freecodecamp/simonSound2.mp3", 
